<nav class="app-header navbar navbar-expand bg-body"> <!--begin::Container-->
    <div class="container-fluid"> <!--begin::Start Navbar Links-->
        ...
        <ul class="navbar-nav ms-auto"> <!--begin::Navbar Search-->
            ...
            <li class="nav-item dropdown user-menu"> <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"> <img src="{{ URL::asset('storage/img/users/' . auth()->user()->image) }}" class="user-image rounded-circle shadow" alt="{{ auth()->user()->image }}"> <span class="d-none d-md-inline">{{ auth()->user()->name }}</span> </a>
                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end"> <!--begin::User Image-->
                    <li class="user-header text-bg-primary"> <img src="{{ URL::asset('storage/img/users/' . auth()->user()->image) }}" class="rounded-circle shadow" alt="{{ auth()->user()->image }}">
                        <p>
